...
const i18n = {
  en: {
    ...
    'proj1.title': 'Cloud Architecture & Integration',
    'proj1.desc': 'Cloud design and system integration for EY. Development of scalable solutions with complex integration patterns.',
    'proj1.tag1': 'AWS',
    'proj1.tag2': 'Azure',
    'proj1.tag3': 'GCP',
    'proj2.title': 'Financial Platform',
    'proj2.desc': 'Development and maintenance of financial web applications with complex payment gateway integration.',
    'proj2.tag1': 'Python',
    'proj2.tag2': 'Node.js',
    'proj2.tag3': 'MySQL',
    'proj3.title': 'Public Sector Solutions',
    'proj3.desc': 'Software development and process management solutions for government institutions.',
    'proj3.tag1': 'C#',
    'proj3.tag2': '.NET',
    'proj3.tag3': 'Java',
    'proj4.title': 'Full Stack Applications',
    'proj4.desc': 'Web applications and APIs built with modern frameworks and cloud-native approaches.',
    'proj4.tag1': 'Java',
    'proj4.tag2': 'React',
    'proj4.tag3': 'PostgreSQL',
    'contact.title': 'CONTACT',
    'contact.subtitle': 'Open to new projects and international opportunities.',
    'footer.text': 'Designed and built with care.',
  },
  ...
  es: {
    ...
    'hero.label': 'Desarrollador Full Stack Senior',
    'hero.name_first': 'Juan Jose</span><span class="accent-letter">',
    'hero.name_last': 'Gomez',
    'hero.name_last2': 'Martinuzzo',
    ...
    'skills.cat3_skill3_name': 'Diseño de bases de datos',
    ...
    'proj1.title': 'Arquitectura Cloud e Integración',
    'proj1.desc': 'Diseño de cloud e integración de sistemas para EY. Soluciones escalables con patrones complejos.',
    'proj1.tag1': 'AWS',
    'proj1.tag2': 'Azure',
    'proj1.tag3': 'GCP',
    'proj2.title': 'Plataforma Financiera',
    'proj2.desc': 'Desarrollo y mantenimiento de aplicaciones web financieras con integración de pasarelas de pago.',
    'proj2.tag1': 'Python',
    'proj2.tag2': 'Node.js',
    'proj2.tag3': 'MySQL',
    'proj3.title': 'Soluciones del Sector Público',
    'proj3.desc': 'Desarrollo de software y gestión de procesos para instituciones gubernamentales.',
    'proj3.tag1': 'C#',
    'proj3.tag2': '.NET',
    'proj3.tag3': 'Java',
    'proj4.title': 'Aplicaciones Full Stack',
    'proj4.desc': 'Aplicaciones web y APIs con frameworks modernos y enfoque cloud-native.',
    'proj4.tag1': 'Java',
    'proj4.tag2': 'React',
    'proj4.tag3': 'PostgreSQL',
  ...
  pt: {
    ...
    'nav.contact': 'CONTATO',
    'hero.label': 'Desenvolvedor Full Stack Sênior',
    'hero.name_first': 'Juan Jose</span><span class="accent-letter">',
    'hero.name_last': 'Gomez',
    'hero.name_last2': 'Martinuzzo',
    'hero.location': 'Guarapari, Espírito Santo, Brasil',
    ...
    'proj1.title': 'Arquitetura Cloud e Integracao',
    'proj1.desc': 'Design de cloud e integracao de sistemas para EY. Solucoes escalaveis com padroes complexos.',
    'proj1.tag1': 'AWS',
    'proj1.tag2': 'Azure',
    'proj1.tag3': 'GCP',
    'proj2.title': 'Plataforma Financeira',
    'proj2.desc': 'Desenvolvimento e manutencao de aplicacoes financeiras com integracao complexa de gateways de pagament.',
    'proj2.tag1': 'Python',
    'proj2.tag2': 'Node.js',
    'proj2.tag3': 'MySQL',
    'proj3.title': 'Solucoes do Setor Público',
    'proj3.desc': 'Desenvolvimento de software e gestao de processos para instituicoes governamentais.',
    'proj3.tag1': 'C#',
    'proj3.tag2': '.NET',
    'proj3.tag3': 'Java',
    'proj4.title': 'Aplicacoes Full Stack',
    'proj4.desc': 'Aplicacoes web e APIs com frameworks modernos e abordagem cloud-native.',
    'proj4.tag1': 'Java',
    'proj4.tag2': 'React',
    'proj4.tag3': 'PostgreSQL',
  ...
  jp: {
    ...
    'proj1.title': 'クラウドアーキテクチャ & 統合',
    'proj1.desc': 'EY向けクラウド設計とシステム統合。複雑な統合パターンによるスケーラブルソリューション。',
    'proj1.tag1': 'AWS',
    'proj1.tag2': 'Azure',
    'proj1.tag3': 'GCP',
    'proj2.title': '金融プラットフォーム',
    'proj2.desc': '複雑な決済ゲートウェイ統合を備えた金融Webアプリの開発・保守。',
    'proj2.tag1': 'Python',
    'proj2.tag2': 'Node.js',
    'proj2.tag3': 'MySQL',
    'proj3.title': '公共部門ソリューション',
    'proj3.desc': '政府機関向けソフトウェア開発とプロセス管理ソリューション。',
    'proj3.tag1': 'C#',
    'proj3.tag2': '.NET',
    'proj3.tag3': 'Java',
    'proj4.title': 'フルスタックアプリケーション',
    'proj4.desc': 'モダンフレームワークとクラウドナティブアプローチによるWebアプリ & API。',
    'proj4.tag1': 'Java',
    'proj4.tag2': 'React',
    'proj4.tag3': 'PostgreSQL',
