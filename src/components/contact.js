  ...
  return `
    <section id="contact" aria-label="Contact">
      ...
      <div class="contact-grid">
        ...
        <a href="https://linkedin.com/in/juanjosegomezmartinuzzo" target="_blank" rel="noopener noreferrer" class="contact-card">
          <div class="contact-icon">
          ...
          <div class="contact-info">
            <h3>LinkedIn</h3>
            <p>juanjosegomezmartinuzzo</p>
          </div>
        </a>
        <a href="https://github.com/juangomezmartinuzzo" target="_blank" rel="noopener noreferrer" class="contact-card">
          <div class="contact-icon">
